...
urlpatterns = [
    ...
    path('delete_guid_booking/<id>',views.delete_guid_booking),
    path('un_user/<id>',views.un_user),
    path('delete_pakage_booking/<id>',views.delete_pakage_booking),
    path('delete_h_booking/<id>',views.delete_h_booking),
